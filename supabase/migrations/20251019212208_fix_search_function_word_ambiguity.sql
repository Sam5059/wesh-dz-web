/*
  # Correction de l'ambiguïté dans la fonction de recherche

  Correction du problème d'ambiguïté de la variable 'word' dans la fonction search_listings
*/

-- Suppression de l'ancienne fonction
DROP FUNCTION IF EXISTS search_listings(TEXT, UUID, UUID, TEXT, TEXT, NUMERIC, NUMERIC, TEXT);

-- Création de la fonction de recherche corrigée
