...
-- D'abord supprimer toutes les fonctions qui utilisent ces tables
DROP FUNCTION IF EXISTS extract_brand_from_title(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS auto_enrich_listing_brand() CASCADE;
DROP FUNCTION IF EXISTS get_brands_by_category(TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_models_by_brand(UUID) CASCADE;

-- Ensuite supprimer les tables
